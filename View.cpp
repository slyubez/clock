...
/*
The IndicatorView class controls four LED digit indicators and the decimal
...
turnOffDecimalPoint(). After setting of all digit values and decimal point
lightning, the method showDigits() must be called. The test() method is
a simple example to show how to work with this class. Also it can be
corrected and called to diagnose hardware faults of LEDs, transistor keys
and wires.
*/
